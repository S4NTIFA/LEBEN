...
<head>
  ...
  <script csr ="../JAVASCRIPT/produccion.js"></script>
      ...
      <div class="formulario">
        ...
        <form method="post" onsubmit="mostrarAlerta()">
          ...
          <div class="campos-linea">
            ...
            <input type="number" id="cantidadEntregada" name="cantidadEntregada" placeholder="Ingrese la cantidad de insumos entregados" oninput="validarCantidad(this)" min="1">
          </div>
          <div class="campos-linea">
